...
const Songs = {
  ...
  library: [
...

    {
      ...
      color: '#3b82f6',
      hasAudioTrack: true,
      mvSrc: '/media/ai-de-jiu-shi-ni-mv.mp4',
      audioSrc: '/media/ai-de-jiu-shi-ni-mv-audio.mp3',
      instrumentalSrc: '/media/ai-de-jiu-shi-ni-mv-instrumental.mp3',
      stripVocals: true,
      hasMelodyData: false,
      pitchGradingReady: false,
      lyricsMode: true,
...

    {
      ...
      color: '#e879f9',
      hasAudioTrack: true,
      mvSrc: '/media/dao-dai-mv.mp4',
      audioSrc: '/media/dao-dai-mv-audio.mp3',
      instrumentalSrc: '/media/dao-dai-mv-instrumental.mp3',
      stripVocals: true,
      hasMelodyData: false,
      pitchGradingReady: false,
      lyricsMode: true,
    ...
    {
      id: 'zhi-shao-hai-you-ni',
      firstVocalSec: 16,
      title: '至少還有你',
      artist: '林憶蓮 Sandy Lam',
      difficulty: 'medium',
      bpm: 72,
      key: 'D Major',
      icon: '🎵',
      color: '#34d399',
      hasAudioTrack: true,
      mvSrc: '/media/zhi-shao-hai-you-ni-mv.mp4',
      audioSrc: '/media/zhi-shao-hai-you-ni-mv-audio.mp3',
      instrumentalSrc: '/media/zhi-shao-hai-you-ni-mv-instrumental.mp3',
      stripVocals: true,
      hasMelodyData: false,
      pitchGradingReady: false,
      lyricsMode: true,
...

    {
      ...
      color: '#fb923c',
      hasAudioTrack: true,
      mvSrc: '/media/tiao-lou-ji-mv.mp4',
      audioSrc: '/media/tiao-lou-ji-mv-audio.mp3',
      instrumentalSrc: '/media/tiao-lou-ji-mv-audio.mp3',
      stripVocals: false,
      hasMelodyData: false,
      pitchGradingReady: false,
      lyricsMode: true,
